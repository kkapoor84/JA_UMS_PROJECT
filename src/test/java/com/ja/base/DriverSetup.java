...
public class DriverSetup {
	...
	public static void initialization() throws Exception {
		...
		if (Property_File_Reader.getvalue("Browser").equalsIgnoreCase("Chrome")) {
			System.setProperty("webdriver.chrome.driver",
					System.getProperty("user.dir") + "/src/test/resources/drivers/chromedriver.exe");
			driver = new ChromeDriver();
		} else if (Property_File_Reader.getvalue("Browser").equalsIgnoreCase("Firefox")) {
			System.setProperty("webdriver.gecko.driver",
					System.getProperty("user.dir") + "/src/test/resources/drivers/geckodriver.exe");
			driver = new FirefoxDriver();
		} else if (Property_File_Reader.getvalue("Browser").equalsIgnoreCase("ie")) {
	...
	public static void openURL() throws Exception {
		...
		driver.get(Property_File_Reader.getvalue("URL"));
